<template>
  <n-space vertical size="large">
    ...
    <n-card title="扩展分类配置">
      ...
      <n-form :model="extendModel" label-placement="left" label-width="140" style="max-width: 720px">
        <n-form-item label="视频剧情/类型">
          <n-input v-model:value="extendModel.vodExtendClass" type="textarea" :rows="2" placeholder="动作,喜剧,爱情,科幻,恐怖,战争,犯罪,动画,奇幻,武侠,冒险,枪战,悬疑,惊悚,经典,青春,文艺,微电影,古装,历史,运动,农村,儿童,网络电影" />
        </n-form-item>
        <n-form-item label="视频地区">
          <n-input v-model:value="extendModel.vodExtendArea" type="textarea" :rows="2" placeholder="大陆,香港,台湾,美国,韩国,日本,泰国,印度,英国,法国,德国,西班牙,加拿大,澳大利亚,其他" />
        </n-form-item>
        <n-form-item label="视频语言">
          <n-input v-model:value="extendModel.vodExtendLang" type="textarea" :rows="2" placeholder="国语,粤语,英语,韩语,日语,法语,德语,泰语,其他" />
        </n-form-item>
        <n-form-item label="视频年份">
          <n-input v-model:value="extendModel.vodExtendYear" type="textarea" :rows="2" placeholder="2025,2024,2023,2022,2021,2020,2019,2018,2017,2016,2015,2014,2013,2012,2011,2010,2009,2008,2007,2006,2005,2004" />
        </n-form-item>
        <n-form-item label="视频版本">
          <n-input v-model:value="extendModel.vodExtendVersion" placeholder="高清版,剧场版,抢先版,OVA,TV" />
        </n-form-item>
