-- Initial database schema for 937 CMS
...
-- Articles
CREATE TABLE IF NOT EXISTS `bb_article_type` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL,
  `status` tinyint unsigned NOT NULL DEFAULT 1,
  `created_at` int unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `bb_comment` (
  ...
  `status` tinyint unsigned NOT NULL DEFAULT 0 COMMENT '0=pending,1=approved',
  `created_at` int unsigned NOT NULL DEFAULT 0,
  `updated_at` int unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
-- Favorites
CREATE TABLE IF NOT EXISTS `bb_favorite` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `member_id` int unsigned NOT NULL,
  `vod_id` int unsigned NOT NULL,
  `created_at` int unsigned NOT NULL DEFAULT 0,
...
-- History
CREATE TABLE IF NOT EXISTS `bb_history` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `member_id` int unsigned NOT NULL,
  `vod_id` int unsigned NOT NULL,
  `episode` int unsigned NOT NULL DEFAULT 0,
